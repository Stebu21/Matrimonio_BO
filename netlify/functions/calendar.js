...
exports.handler = async () => {
  try {
    // Settings è una tabella key-value (key, value)
    ...
    if (!S.data_matrimonio) {
      return {
        statusCode: 500,
        body: JSON.stringify({ error: 'data_matrimonio non configurata' })
      };
    }

    // Timeline ordinata per sort_order
    ...
    const date = new Date(S.data_matrimonio);
